...
if BOT:
    ...
    ["* **demo report**", "Create a demo report for all features currently in the feature encyclopedia"]])
    ...
    bot.add_command("demo report", "Create a demo report for all features currently in the feature encyclopedia", greeting)
